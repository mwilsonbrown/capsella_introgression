...
#### Co-occurrences?
I want to try to do some kind of co-occurance matrix analysis to see how often introgressed regions are co-occurring with other regions
```{r}
# to get the binary matrix 
nyc_inter_bmat <- nyc_inter[,6:length(colnames(nyc_inter))]



# re-list data by scaffold
nyc_inter_ls <- split(nyc_inter, f = nyc_inter$chrom)
```
