...
# why is the order wrong >:(
ggsave(paste0(temp_plotdir,"neu_viterbi_all2.png"),neu_allc, units = "in", height = 12, width = 19)
```
...
# why is the order wrong >:(
ggsave(paste0(temp_plotdir,"mena_viterbi_all2.png"),mena_allc, units = "in", height = 12, width = 19)
```
...
# why is the order wrong >:(
ggsave(paste0(temp_plotdir,"easia_viterbi_all2.png"),easia_allc, units = "in", height = 12, width = 19)
```
