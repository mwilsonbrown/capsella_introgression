...
ggsave(paste0(temp_plotdir,"ny_viterbi_all4.png"),nyc_allc, units = "in", height = 5, width = 14)
```
...
# why is the order wrong >:(
ggsave(paste0(temp_plotdir,"neu_viterbi_all4.png"),neu_allc, units = "in", height = 5, width = 10)
```
...
# why is the order wrong >:(
ggsave(paste0(temp_plotdir,"mena_viterbi_all4.png"),mena_allc, units = "in", height = 5, width = 6.7)
```
...
row_sind <- seq(from = 1, to = nrow(sc14), by = 1000)
row_eind <- c(seq(from = 1, to = nrow(sc14), by = 1000)-1)[2:length(row_sind)]
winds <- data.frame(start = row_sind[-51], end = row_eind) #rows for extracting bp positions from names

# from the row names, get the staring and ending bp positions
bp_ends <- as.numeric(str_remove(rownames(sc14)[winds$end], "jlSCF_14_"))
bp_beg <- as.numeric(str_remove(rownames(sc14)[winds$start], "jlSCF_14_"))
