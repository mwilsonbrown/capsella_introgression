...
vcf_samp <- read.csv("~/Documents/PhD/Research/vcf_filtering/individuals/j19_in_vcf.txt",
                     sep = "\t",
                     header = F)
...
Note: manually removed ERR636135.sam from cr samples
...
ancestry_hmm \
  -v \
  -i ahmm_formated.input \
  -s ahmm_formated.ploidy \
  -a 2 0.3 0.7 \
  -p 0 -50000 -0.3 \
  -p 1 -350000 -0.7
```
