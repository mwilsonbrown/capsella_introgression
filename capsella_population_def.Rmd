...
conditional_dir = "~/Documents/PhD/Research/admixture/nyc_eurasian_conditional/"
```
...
world + geom_point(data=ea_k2, aes(x=longitude, y=latitude, fill = anc_group, color = NULL), shape=21) +
  scale_fill_manual(values = c("pop1" = "#4DBBD5FF", "pop2" = "orange"))
...
```{r}
# data for k = 4 on European group data
ea_k4 <- ancestry_bars(ea_ancestry_propsK, K = 4, sample_names_fam = ea_fam, ggplot_opt = scale_fill_manual(values = c("pop1" = "#2B3A67", "pop2" = "#84A98C", "pop3" = "#DA2C38", "pop4" = "#FFC482")))
...
```{r}
# world map
world + geom_point(data=ea_k4, aes(x=longitude, y=latitude, fill = anc_group, color = NULL), shape=21) + scale_fill_manual(values = c("pop1" = "#2B3A67", "pop2" = "#84A98C", "pop3" = "#DA2C38", "pop4" = "#FFC482"))

ggsave("~/Documents/PhD/Research/admixture/plots_temp/eurasian_cbp_k4_eurasia_map.png", width = 13, height = 7, units = "in")
```
...
# map
ny_map + geom_point(data=subset(nyc_k2, state == c("NY", "NJ")), aes(x=longitude, y=latitude, fill = anc_group), shape = 21) + scale_fill_manual(values = c("pop1" = "#4DBBD5FF", "pop2" = "orange"))

ggsave("~/Documents/PhD/Research/admixture/plots_temp/nyc_cbp_k2_nyc_map.png", width = 13, height = 7, units = "in")
```
...
```{r}
# ancestry bar plots
nyc_k4 <- ancestry_bars(nyc_ancestry_propsK, K = 4, list_element = 2, nyc_fam, ggplot_opt = scale_fill_manual(values = c("pop1" = "#2B3A67", "pop2" = "#84A98C", "pop3" = "#DA2C38", "pop4" = "#FFC482")))
...
# map
ny_map + geom_point(data=subset(nyc_k4, state == c("NY", "NJ")), aes(x=longitude, y=latitude, fill = anc_group), shape = 21) + scale_fill_manual(values = c("pop1" = "#2B3A67", "pop2" = "#84A98C", "pop3" = "#DA2C38", "pop4" = "#FFC482"))

ggsave("~/Documents/PhD/Research/admixture/plots_temp/nyc_cbp_k4_nyc_map.png", width = 13, height = 7, units = "in")
```
