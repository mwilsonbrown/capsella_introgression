...
# get sample to majority ancestry population key
k4_key <- assign_ancestry(ea_ancestry_propsK, K=4, ea_fam)
...
# get sample to majority ancestry population key
ny_k2_key <- assign_ancestry(nyc_ancestry_propsK, K=2, nyc_fam)
...
###### Comparing summary tools
Pong, CLUMMP, ConSTRUCT,
