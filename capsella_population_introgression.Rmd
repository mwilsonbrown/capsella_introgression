...
ggplot() + geom_segment(data = nyc_inter, aes(colour= num, x=chrom, xend=chrom, y=start, yend=end), size = 10) + scale_color_continuous(high = "violetred4", low = "mistyrose") + ggtitle("New York introgressed regions") + theme_classic()
```
